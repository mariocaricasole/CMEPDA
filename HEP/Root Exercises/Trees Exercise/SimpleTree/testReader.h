...
// Tue Mar 28 11:33:02 2023 by ROOT version 6.28/00
// from TTree tree/Example TTree
// found on file: SimpleTree.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("SimpleTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("SimpleTree.root");
      }
